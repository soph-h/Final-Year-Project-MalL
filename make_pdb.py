...
def create_pdb(structure,index,time,tp):
    ...
    trajin /bp1/mulholland/zn22275/300K_MalL_{structure}/dry_run_{index}/dry_md{time}.nc

    trajout /user/work/zn22275/{structure}_dry_pdb/run_{index}/dry_md{time}_{tp}.pdb onlyframes {tp} pdb
